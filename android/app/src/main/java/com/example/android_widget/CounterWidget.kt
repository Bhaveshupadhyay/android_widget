 ...
 * App Widget Configuration implemented in [CounterWidgetConfigureActivity]
 */
    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            val views = RemoteViews(context.packageName, R.layout.counter_widget).apply {
                ...
                setTextViewText(R.id.appwidget_text, counter.toString() ?: "No title set")
                val incrementIntent = HomeWidgetBackgroundIntent.getBroadcast(
                    context,
                    Uri.parse("homeWidgetCounter://increment")
                )
                setOnClickPendingIntent(R.id.increase_btn, incrementIntent)
